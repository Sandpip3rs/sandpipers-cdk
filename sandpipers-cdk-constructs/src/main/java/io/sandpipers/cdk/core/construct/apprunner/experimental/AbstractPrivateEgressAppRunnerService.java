...
@Getter
public abstract class AbstractPrivateEgressAppRunnerService<T extends PrivateEgressAppRunnerServiceProps> extends
  ...
  protected VpcConnector createVpcConnector(final Construct scope,
      final T props) {
