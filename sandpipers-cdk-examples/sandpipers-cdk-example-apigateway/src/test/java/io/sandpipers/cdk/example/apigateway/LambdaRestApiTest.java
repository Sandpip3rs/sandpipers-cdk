...
public class LambdaRestApiTest extends TemplateSupport {
  ...
  static void initAll() {
    ...
    tagResources(lambdaRestApiStack, SANDPIPERS_TEST_111111111111_AP_SOUTHEAST_2, app.getApplicationName());
  ...
  void should_have_permission_to_allow_rest_api_call_lambda_from_deployment_stage_test() {
    ...
    final String sourceArnPattern = "^arn:aws:execute-api::ap-southeast-2:LambdaRestApi[a-zA-Z0-9]{8}/LambdaRestApiDeploymentStageTest[a-zA-Z0-9]{8}/\\*/\\*$";
    final String lambdaPermissionResourceId = "^LambdaRestApiproxyANYApiPermissionSandpipersApigatewayCdkExampleStakeLambdaRestApi[a-zA-Z0-9]{8}ANYproxy[a-zA-Z0-9]{8}$";
  ...
  void should_have_permission_to_allow_rest_api_call_lambda_from_test_invoke_stage() {
    ...
    final String principal = "apigateway.amazonaws.com";
    final String functionName = "^Function[a-zA-Z0-9]{8}$";
    final String sourceArnPattern = "^arn:aws:execute-api::ap-southeast-2:LambdaRestApi[a-zA-Z0-9]{8}/test-invoke-stage/\\*/\\*$";
    final String lambdaPermissionResourceId = "^LambdaRestApiproxyANYApiPermissionTestSandpipersApigatewayCdkExampleStakeLambdaRestApi[a-zA-Z0-9]{8}ANYproxy[a-zA-Z0-9]{8}$";
  ...
  void should_have_permission_to_allow_rest_api_call_lambda_from_deployment_stage_test_without_wildcards() {
    ...
    final String functionName = "^Function[a-zA-Z0-9]{8}$";
    final String sourceArnPattern = "^arn:aws:execute-api::ap-southeast-2:LambdaRestApi[a-zA-Z0-9]{8}/LambdaRestApiDeploymentStageTest[a-zA-Z0-9]{8}/\\*/$";
    final String lambdaPermissionResourceId = "^LambdaRestApiANYApiPermissionSandpipersApigatewayCdkExampleStakeLambdaRestApi[a-zA-Z0-9]{8}ANY[a-zA-Z0-9]{8}$";
  ...
  void should_have_permission_to_allow_rest_api_call_lambda_from_test_invoke_stage_without_wildcards() {
    ...
    final String functionName = "^Function[a-zA-Z0-9]{8}$";
    final String sourceArnPattern = "^arn:aws:execute-api::ap-southeast-2:LambdaRestApi[a-zA-Z0-9]{8}/test-invoke-stage/\\*/$";
    final String lambdaPermissionResourceId = "^LambdaRestApiANYApiPermissionTestSandpipersApigatewayCdkExampleStakeLambdaRestApi[a-zA-Z0-9]{8}ANY[a-zA-Z0-9]{8}$";
