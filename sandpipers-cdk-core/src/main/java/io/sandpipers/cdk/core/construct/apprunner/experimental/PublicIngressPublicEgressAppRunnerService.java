...
public class PublicIngressPublicEgressAppRunnerService<T extends AppRunnerServiceProps> extends AbstractAppRunnerService<T> {

  public PublicIngressPublicEgressAppRunnerService(@NotNull final Construct scope,
